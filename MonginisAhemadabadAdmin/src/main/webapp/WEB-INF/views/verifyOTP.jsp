...
<c:url value="/reGenOtp1" var="reGenOtp1"></c:url>
	...
	<div class="row">
		...
		<div class="col-md-8">
			...
			<h3 class="login_head">OTP Verification</h3>
			
			<div class="form-group">
				<div class="controls">
					<input type="text" placeholder="Enter OTP sent on your registered mobile No." class="form-control" id="otp" name="otp" maxlength="6" required/>
			...
			<div class="form-group">
				<div class="controls">
					<button type="button" class="btn btn-primary form-control" onclick="reGenOtp()" style="background: #ec268f;">Resend OTP</button>
				</div>
			</div>
