								...
								<!-- 	<div id="faux-table" class="faux-table" aria="hidden">
									...
									<div class="table-wrap">
										...
										<table id="table1" class="table table-advance" style="">
                                            ...
                                            <th width="10" class="col-md-1" style="text-align: left;">Sr No</th>
											<th width="10" class="col-md-1" style="text-align: left;">Section Id</th>
											<th width="10" class="col-md-3" style="text-align: left;">Section Name</th>
<!-- 										<th class="col-md-2">Image</th>
 -->										<th width="10" class="col-md-2" style="text-align: left;">Section Type</th>
											<th width="10" class="col-md-2" style="text-align: left;">MenuIds</th>
											<th width="10" class="col-md-3" style="text-align: left;">Action</th>
												</tr>
											</thead>
									<tbody>
								...
								<c:forEach items="${secList}" var="sec" varStatus="count">
											<tr>
												...
												<td align="left"><a href="updateSection/?secId=${sec.sectionId}"><span
														class="glyphicon glyphicon-edit"></span></a>&nbsp;&nbsp;
                                             <a href="deleteSection/?secId=${sec.sectionId}""><span
