...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/tableSearch.css">
			...
			<div class="row hidden-xs">
				<div class="col-md-12">
					<div class="box box-pink">
						<div class="box-title">
							<h3>
								<i class="fa fa-bars"></i> Rejection List !!!
							</h3>
							<div class="box-tool">
 ...
 -->
						<div class="box-content">
									...
									<div class="col-md-9" ><a class="btn btn-primary"  href="${pageContext.request.contextPath}/showRejectiontionHeaderDetail">Add Rejection</a>
							</div> 
					<label for="search" class="col-md-3" id="search">
							...
							<div class="clearfix"></div>
								...
								<div id="table-scroll" class="table-scroll">
									...
									<div id="faux-table" class="">
									<table id="table3" class="table table-advance">
											<thead>
												<tr class="bgpink">
											
                                            <th width="10" class="col-md-1" style="text-align: left;">Sr No1</th>
											<th width="10" class="col-md-1" style="text-align: center;">Header Remark</th>
											<th  class="col-md-1" style="text-align: center;">Remark</th>
											<th class="col-md-1" style="text-align: left;">Action</th>
										
												</tr>
												</thead>
												<tbody>
												<c:forEach items="${headList}" var="rejectHead" varStatus="count">
											<tr>
										

												<td style="padding-left: 2%;"><c:out value="${count.index+1}" /></td>
												 <td style="text-align: center; padding-left: ">
													<c:out value="${rejectHead.remarkId}" /></td>
												<td style="text-align: center; padding-left:">
													<c:out value="${rejectHead.remark}"/></td> 
												<td align="center"><a href="updateRejHead/?rejId=${rejectHead.rejectId}"><span
														class="glyphicon glyphicon-edit"></span></a>&nbsp;&nbsp;
                                       
													&nbsp;&nbsp;
													<a href="deleteRejHead/?rejId=${rejectHead.rejectId}" 
